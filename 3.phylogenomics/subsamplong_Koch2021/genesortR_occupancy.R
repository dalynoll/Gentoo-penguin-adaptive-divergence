...
#setwd('/Users/dalynoll/Dropbox/Investigaciones/gentoo/PAPERS_TESIS_DOCTORAL/Evolutionary_history_gentoo/1.Paper_Gentoo_adaptive divergence/AAA_paper_adaptive_divergence_gentoo/Communication_biology/Revision1/nuevos_analisis/species_tree_georgias/ortologos/7koch')
list.files()
#INPUT: fill this with file names
alignment <- 'concatenated_3513.fasta'
partition <- 'partition.txt'
species_tree <- 'astral_all_3513_treefile_rooted.nwk'
gene_trees <- 'gene_tree_3513.nwk'
...
ingroup <- c('cro07', 'cro08', 'g5', 'gen04', 'gsa10', 'gsa14', 'gtp06', 'gtp12', 'mq9209', 'mq9312', 'p0048', 'p0052', 'p0196', 'p0200', 'p0407', 'p0409', 'p1884', 'p2136', 'pam1', 'pam10', 'pam3', 's15a2', 's22a1', 's24a1', 'southgeorgia')
